 ...
 */
final class Version20220825100144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer ADD CONSTRAINT FK_DADD4A25FD2E7CF7 FOREIGN KEY (correct_answer_id) REFERENCES answer (id)');
